...
5. Build and deploy the API behind TLS, a reverse proxy/WAF, and provider network restrictions. Do not publicly expose databases, caches, dashboards, or storage buckets.
